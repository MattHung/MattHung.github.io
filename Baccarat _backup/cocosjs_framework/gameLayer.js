...
var gameLayer = cc.Layer.extend({
    ...
    ctor:function(resName_or_rootNode){
        ...
        this._eventFilter = new eventFilter();
    ...
    hit_test:function(point){
        return this._eventFilter.castNode(point);
    },

    hit_test_move:function(point){
        return this._eventFilter.castMoveNode(point);
    },

    addSender:function(sender){
        this._eventFilter.addSender(sender);
    },

    resetSender: function (sender) {
        this._eventFilter.removeSender(sender);
    },
